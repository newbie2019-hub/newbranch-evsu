          ...
          <div class="card p-5">
            <div class="d-flex justify-content-end">
              <button
                ...
                v-on:click.prevent="$bvModal.show('addStudentModal')"
              >
              ...
              <table class="table table-striped table-hover">
                ...
                <tbody>
                  <tr v-for="(stud, i) in students.data" :key="i">
                    ...
                    <td>{{ stud.email }}</td>
                    <td class="text-nowrap">
                      Year Level - {{ stud.userinfo.section.year_level }}
                    </td>
                    <td class="text-nowrap">
    ...
    <div class="col-12 col-sm-11 col-md-12 col-lg-11 col-xl-11 mt-4">
     <div class="card p-5">
      ...
      <div class="table-responsive mt-4" v-if="pending_students.data.length > 0">
        <table class="table table-striped table-hover">
         <caption>Showing {{pending_students.from}} to {{pending_students.to}} out of {{pending_students.total}} data</caption>
         <thead>
           <tr>
             <th scope="col">ID</th>
             <th scope="col" class="text-nowrap">Student ID</th>
    ...
    <b-modal id="addStudentModal" scrollable centered title="Add Student">
      ...
      <div class="row">
        ...
        <div class="col-6">
          ...
          >
            <option
              v-for="(sec, i) in filteredSection"
              :key="i"
              :value="sec.id"
              >{{ sec.section }}</option
            >
        ...
        <div class="col-6">
          ...
          >
            <option
              :value="org.id"
              v-for="(org, i) in allorganizations"
              :key="i"
              >{{ org.organization }} -
              <span class="text-muted">{{ org.abbreviation }}</span></option
            >
          </select>
        </div>
      </div>
    ...
    <b-modal id="updateStudentModal" scrollable centered title="Update Student">
      ...
      <div class="row pb-2">
        <div class="col-6">
          <label class="mt-2" for="studentid">Student ID</label>
          <input
            v-model="update_data.student_id"
            id="studentid"
            type="text"
            class="form-control"
            placeholder=""
      ...
      <div class="row">
        <div class="col-6">
          <label class="mt-2" for="fname">First Name</label>
          <input
            v-model="update_data.userinfo.first_name"
            id="fname"
            type="text"
            class="form-control"
            placeholder=""
        ...
        <div class="col-6">
          <label class="mt-2" for="mname">Middle Name</label>
          <input
            v-model="update_data.userinfo.middle_name"
            id="mname"
            type="text"
            class="form-control"
            placeholder=""
      ...
      <div class="row">
        <div class="col-6">
          <label class="mt-2" for="lname">Last Name</label>
          <input
            v-model="update_data.userinfo.last_name"
            id="lname"
            type="text"
            class="form-control"
            placeholder=""
        ...
        <div class="col-6">
          <label class="mt-2" for="mname">Gender</label>
          <select
            v-model="update_data.userinfo.gender"
            id="mname"
            type="text"
            class="form-select"
            placeholder=""
      ...
      <div class="row">
        <div class="col-6">
          <label class="mt-2" for="contact">Contact</label>
          <input
            v-model="update_data.userinfo.contact"
            id="contact"
            type="text"
            class="form-control"
            placeholder=""
        ...
        <div class="col-6">
          <label class="mt-2" for="type">Type</label>
          <select
            v-model="update_data.userinfo.type"
            id="type"
            type="text"
            class="form-select"
            placeholder=""
      ...
      <div class="row">
        ...
        <div class="col-6">
          <label class="mt-2" for="section">Section</label>
          <select
            v-model="update_data.userinfo.section_id"
            id="section"
            class="form-select"
            placeholder=""
          >
            <option
              :value="sec.id"
              v-for="(sec, i) in filteredUpdateSection"
              :key="i"
              >{{ sec.section }}</option
            >
          </select>
        ...
        <div class="col-6">
          <label class="mt-2" for="organizationid">Organization</label>
          <select
            v-model="update_data.userinfo.organization_id"
            id="organizationid"
            class="form-select"
            placeholder=""
          >
    ...
    <b-modal id="deleteStudentModal" centered title="Confirm Delete">
      ...
      <template #modal-footer="{cancel}">
        ...
        <b-button
          variant="success"
          size="sm"
          v-on:click.prevent="deleteStudent"
          :disabled="isLoading"
        >
          Delete
        </b-button>
...
export default {
  ...
  methods: {
    ...
    async saveStudent() {
      ...
      if (this.data.first_name.trim() == "")
        return this.$toast.error("First Name is required");
      if (this.data.middle_name.trim() == "")
        return this.$toast.error("Middle Name is required");
      if (this.data.last_name.trim() == "")
        return this.$toast.error("Last Name is required");
      if (this.data.gender == "")
        return this.$toast.error("Gender is required");
      if (this.data.contact == "")
        return this.$toast.error("Contact is required");
      if (this.data.type == "")
        return this.$toast.error("Account Type is required");
    ...
    async updateStudent() {
      if (this.update_data.student_id == "")
        return this.$toast.error("Student ID is required");
      if (this.update_data.email == "")
        return this.$toast.error("Email is required");
      if (this.update_data.password == "")
        return this.$toast.error("Password is required");
      if (this.update_data.userinfo.first_name.trim() == "")
        return this.$toast.error("First Name is required");
      if (this.update_data.userinfo.middle_name.trim() == "")
        return this.$toast.error("Middle Name is required");
      if (this.update_data.userinfo.last_name.trim() == "")
        return this.$toast.error("Last Name is required");
      if (this.update_data.userinfo.gender == "")
        return this.$toast.error("Gender is required");
      if (this.update_data.userinfo.contact == "")
        return this.$toast.error("Contact is required");
      if (this.update_data.userinfo.type == "")
        return this.$toast.error("Account Type is required");
      if (this.update_data.userinfo.year_level == "")
        return this.$toast.error("Year Level is required");
      if (this.update_data.userinfo.organization_id == "")
        return this.$toast.error("Organization is required");
